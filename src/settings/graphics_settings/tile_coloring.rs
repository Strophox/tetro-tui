    ...
    pub fn tile_col(&self, tile: TileType, level: usize) -> (Color, Color) {
        match self {
            ...
            TileColoring::HardcodedNES => {
                ...
                const COLOR_RUN_GLITCHED: [(usize, usize, usize); 54] = [
                    (0x26, 0x29, 0x25),
                    (0x09, 0x14, 0x30),
                    (0x29, 0x20, 0x05),
                    (0x26, 0x09, 0x25),
                    ...
                    (0x20, 0x30, 0x16),
                    (0x3f, 0x09, 0x01),
                    (0x20, 0x25, 0x24), // Bubble gum
                    (0x00, 0x10, 0x3f), // Charcoal
                    (0x24, 0x25, 0x37),
                    (0x25, 0x20, 0x2b),
                    (0x05, 0x26, 0x0c),
                    (0x18, 0x25, 0x25),
                    (0x37, 0x10, 0x36), // Sepia
                    (0x24, 0x09, 0x1c),
                    (0x30, 0x29, 0x00),
                    (0x24, 0x05, 0x05),
                    (0x02, 0x29, 0x02),
                    ...
                    (0x26, 0x13, 0x26),
                    (0x3d, 0x00, 0x3f),
                    (0x0a, 0x0a, 0x0a), // 800l green horror monster
                    (0x07, 0x2a, 0x3d),
                    (0x19, 0x20, 0x20),
                    (0x19, 0x20, 0x26),
                    (0x25, 0x17, 0x18),
