...
### Changed
- Made scoreboard sorting cleaner by ignoring 'derivatives' at the end (e.g. "Regular [5]").
...
## Fixed
- Adjusted menu code to use a workaround so the slow Windows terminal doesn't flicker.
